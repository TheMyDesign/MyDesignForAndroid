...
import static com.example.mydesign.env.TOKEN;

import android.os.AsyncTask;

import com.example.mydesign.controler.OnUrlGeneratedListener;
...
public class OpenAi {
    ...
    private OnUrlGeneratedListener listener; // default to null d
